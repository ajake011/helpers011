...
<head>
<meta charset="utf-8">
<title>HelPers Project / <?php echo $title;?></title>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">HelPers</a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="<?php echo !isset($_GET['q'])? 'active' :''?>"><a href="<?php echo web_root; ?>index.php">Home</a></li> 
                       </li> 
                       <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='searchjob'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=searchjob">Search Job</a></li>
